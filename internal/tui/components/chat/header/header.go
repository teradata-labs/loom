...
func New(lspClients interface{}) Header {
	return &header{
...
func (h *header) View() string {
	...
	// Loom branding instead of Crush
	b.WriteString(t.S().Base.Foreground(t.Secondary).Render("Teradata™"))
	b.WriteString(gap)
	b.WriteString(styles.ApplyBoldForegroundGrad("LOOM", t.Secondary, t.Primary))
	b.WriteString(gap)
