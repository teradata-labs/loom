...
import (
	...
	"github.com/teradata-labs/loom/internal/stringext"
	cmpChat "github.com/teradata-labs/loom/internal/tui/components/chat"
...
func (a *appModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case commands.ShowMCPPromptArgumentsDialogMsg:
		...
		for _, arg := range msg.Prompt.Arguments {
			args = append(args, commands.Argument{
				Name:        arg.Name,
				Title:       arg.Name, // Use name as title
...
func (a *appModel) View() tea.View {
	...
	if a.sendProgressBar && a.app != nil && a.app.AgentCoordinator != nil && a.app.AgentCoordinator.IsBusy(a.app.AgentCoordinator.GetAgentID()) {
		// HACK: use a random percentage to prevent ghostty from hiding it
		// after a timeout.
		// #nosec G404 -- UI progress bar animation, not security-sensitive
