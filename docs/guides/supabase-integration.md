...
```bash
export LOOM_STORAGE_POSTGRES_DSN="postgresql://postgres.abcdefghijklmnop:MySecretPass123@aws-1-us-east-1.pooler.supabase.com:5432/postgres?sslmode=require"
```
