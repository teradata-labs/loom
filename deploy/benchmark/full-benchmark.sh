...
#   3. Deploys Loom server
#   4. Runs all 12 benchmark scenarios
#   5. Collects all results (optionally scales down node pools with --cleanup)
#
...
echo "=== Step 1/5: Ensuring AKS infrastructure ==="
...
echo "=== Step 3/5: Deploying Loom server ==="
...
echo "=== Step 4/5: Running Loom scenarios (${SCENARIO}) ==="
...
echo "=== Step 5/5: Collecting results ==="
mkdir -p "${RESULTS_DIR}"
