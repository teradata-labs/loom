...
5. Facilitator receives responses via event-driven auto-delivery
...
- **Broadcast Bus**: Topic-based pub-sub (USED: publish). Messages are event-driven and auto-delivered.
...
5. Other agents receive the responses automatically (event-driven auto-delivery)
...
4. Use `publish()` to broadcast (messages are auto-delivered to subscribers)
