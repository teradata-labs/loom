...
const (
	...
	LoomService_CreateWorkflowFromTemplate_FullMethodName  = "/loom.v1.LoomService/CreateWorkflowFromTemplate"
)
...
type LoomServiceClient interface {
	...
	// ListAgentPresets returns the set of preconfigured single-agent presets.
	ListAgentPresets(ctx context.Context, in *ListAgentPresetsRequest, opts ...grpc.CallOption) (*ListAgentPresetsResponse, error)
	// ListWorkflowTemplates returns the set of preconfigured workflow templates.
	...
	// CreateWorkflowFromTemplate instantiates a template: creates each agent
	// in the template (reusing by name where possible), then creates a
...
func (c *loomServiceClient) ListAgentPresets(ctx context.Context, in *ListAgentPresetsRequest, opts ...grpc.CallOption) (*ListAgentPresetsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListAgentPresetsResponse)
	err := c.cc.Invoke(ctx, LoomService_ListAgentPresets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loomServiceClient) ListWorkflowTemplates(ctx context.Context, in *ListWorkflowTemplatesRequest, opts ...grpc.CallOption) (*ListWorkflowTemplatesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListWorkflowTemplatesResponse)
	err := c.cc.Invoke(ctx, LoomService_ListWorkflowTemplates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loomServiceClient) CreateWorkflowFromTemplate(ctx context.Context, in *CreateWorkflowFromTemplateRequest, opts ...grpc.CallOption) (*CreateWorkflowFromTemplateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateWorkflowFromTemplateResponse)
	err := c.cc.Invoke(ctx, LoomService_CreateWorkflowFromTemplate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLoomServiceServer) ListAgentPresets(context.Context, *ListAgentPresetsRequest) (*ListAgentPresetsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAgentPresets not implemented")
}
func (UnimplementedLoomServiceServer) ListWorkflowTemplates(context.Context, *ListWorkflowTemplatesRequest) (*ListWorkflowTemplatesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListWorkflowTemplates not implemented")
}
func (UnimplementedLoomServiceServer) CreateWorkflowFromTemplate(context.Context, *CreateWorkflowFromTemplateRequest) (*CreateWorkflowFromTemplateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateWorkflowFromTemplate not implemented")
}
...
func _LoomService_ListAgentPresets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAgentPresetsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoomServiceServer).ListAgentPresets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LoomService_ListAgentPresets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoomServiceServer).ListAgentPresets(ctx, req.(*ListAgentPresetsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _LoomService_ListWorkflowTemplates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListWorkflowTemplatesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoomServiceServer).ListWorkflowTemplates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LoomService_ListWorkflowTemplates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoomServiceServer).ListWorkflowTemplates(ctx, req.(*ListWorkflowTemplatesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _LoomService_CreateWorkflowFromTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateWorkflowFromTemplateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoomServiceServer).CreateWorkflowFromTemplate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LoomService_CreateWorkflowFromTemplate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoomServiceServer).CreateWorkflowFromTemplate(ctx, req.(*CreateWorkflowFromTemplateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LoomService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LoomService_ListAgentPresets_Handler,
		},
		{
			MethodName: "ListWorkflowTemplates",
			Handler:    _LoomService_ListWorkflowTemplates_Handler,
		},
		{
			MethodName: "CreateWorkflowFromTemplate",
			Handler:    _LoomService_CreateWorkflowFromTemplate_Handler,
		},
	},
