...
func TestLoadMigrations(t *testing.T) {
	...
	// Verify we have all 16 migrations.
	...
	// 000015_rls_infrastructure_tables, then 000016_rls_honor_jwt_sub.
	assert.Len(t, migrations, 16, "should have 16 migration versions")
