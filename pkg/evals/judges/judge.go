...
func (h *LLMJudge) convertVerdictToResult(verdict *llmjudge.Verdict, evalCtx *loomv1.EvaluationContext) *loomv1.JudgeResult {
	...
	return &loomv1.JudgeResult{
		...
		Criteria:           h.Criteria(),
		FactualAccuracy:    types.SafeInt32(verdict.FactualAccuracy),
		HallucinationScore: types.SafeInt32(verdict.HallucinationScore),
		QueryQuality:       types.SafeInt32(verdict.QueryQuality),
		Completeness:       types.SafeInt32(verdict.Completeness),
